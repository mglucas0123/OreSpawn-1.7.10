 ...
 *  danger.orespawn.RenderWormLarge
...
import danger.orespawn.ModelWormLarge;
...
extends RenderLiving {
    ...
    private static final ResourceLocation texture = new ResourceLocation("orespawn", "WormLargetexture.png");

    public RenderWormLarge(ModelWormLarge par1ModelBase, float par2, float par3) {
        super((ModelBase)par1ModelBase, par2 * par3);
        this.model = (ModelWormLarge)this.mainModel;
        this.scale = par3;
    }

    public void renderWormLarge(WormLarge par1WormLarge, double par2, double par4, double par6, float par8, float par9) {
