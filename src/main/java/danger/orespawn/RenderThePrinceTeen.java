 ...
 *  danger.orespawn.RenderThePrinceTeen
...
import danger.orespawn.ModelThePrinceTeen;
...
extends RenderLiving {
    ...
    private static final ResourceLocation texture = new ResourceLocation("orespawn", "PrinceTeentexture.png");

    public RenderThePrinceTeen(ModelThePrinceTeen par1ModelBase, float par2, float par3) {
