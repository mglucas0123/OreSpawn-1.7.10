 ...
 *  danger.orespawn.RenderGammaMetroid
...
import danger.orespawn.ModelGammaMetroid;
...
extends RenderLiving {
    ...
    private static final ResourceLocation texture = new ResourceLocation("orespawn", "GammaMetroid.png");

    public RenderGammaMetroid(ModelGammaMetroid par1ModelBase, float par2, float par3) {
