 ...
 *  danger.orespawn.RenderThePrince
...
import danger.orespawn.ModelThePrince;
...
extends RenderLiving {
    ...
    private static final ResourceLocation texture = new ResourceLocation("orespawn", "ThePrincetexture.png");

    public RenderThePrince(ModelThePrince par1ModelBase, float par2, float par3) {
        super((ModelBase)par1ModelBase, par2 * par3);
        this.model = (ModelThePrince)this.mainModel;
        this.scale = par3;
    }

    public void renderThePrince(ThePrince par1EntityThePrince, double par2, double par4, double par6, float par8, float par9) {
    ...
    protected void preRenderScale(ThePrince par1Entity, float par2) {
