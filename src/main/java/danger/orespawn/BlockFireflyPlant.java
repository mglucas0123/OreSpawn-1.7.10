 ...
 *  danger.orespawn.BlockFireflyPlant
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if (bid == Blocks.air && !par1World.isDaytime() && OreSpawnMain.FireflyEnable != 0) {
            ...
            for (int i = 0; i < rate; ++i) {
                BlockFireflyPlant.spawnCreature((World)par1World, (String)"Firefly", (double)((double)par2 + 0.5), (double)((double)par3 + 1.01), (double)((double)par4 + 0.5));
            }
        }
    }
