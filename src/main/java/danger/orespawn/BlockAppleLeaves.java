            ...
            for (int var12 = - var7; var12 <= var7; ++var12) {
                for (int var13 = - var7; var13 <= 0; ++var13) {
                    for (int var14 = - var7; var14 <= var7; ++var14) {
                        ...
                        if ((t %= 24000L) > 12000L && par1World.provider.dimensionId == OreSpawnMain.DimensionID4) {
                            OreSpawnMain.setBlockFast((World)par1World, (int)par2, (int)par3, (int)par4, (Block)OreSpawnMain.MyScaryLeaves, (int)0, (int)3);
                        }
                        return;
                    }
                }
