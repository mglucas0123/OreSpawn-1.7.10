 ...
 *  danger.orespawn.BlockMothPlant
...
extends BlockCrops {
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if (bid == Blocks.air && !par1World.isDaytime() && OreSpawnMain.MothEnable != 0) {
            BlockMothPlant.spawnCreature((World)par1World, (String)"Moth", (double)((double)par2 + 0.5), (double)((double)par3 + 1.01), (double)((double)par4 + 0.5));
        }
    }
