...
extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue((double)OreSpawnMain.LurkingTerror_stats.attack);
    }
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (LurkingTerror)this.worldObj.findNearestEntityWithinAABB(LurkingTerror.class, this.boundingBox.expand(32.0, 16.0, 32.0), (Entity)this);
        if (target != null) {
            return false;
        }
        if (this.posY < 10.0) {
