...
extends EntityLiving {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue((double)OreSpawnMain.Godzilla_stats.health);
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        List var5 = this.worldObj.getEntitiesWithinAABB(Godzilla.class, this.boundingBox.expand(32.0, 32.0, 32.0));
    ...
    public void onUpdate() {
        ...
        if (this.worldObj.isRemote) {
            ...
            if (var2.hasNext()) {
                var3 = (Entity)var2.next();
                var4 = (Godzilla)var3;
                this.posY = var4.posY + 16.0;
                this.posX = var4.posX - 17.0 * Math.sin(Math.toRadians(var4.rotationYawHead));
                this.posZ = var4.posZ + 17.0 * Math.cos(Math.toRadians(var4.rotationYawHead));
