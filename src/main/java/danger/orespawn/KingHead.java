...
extends EntityLiving {
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        List var5 = this.worldObj.getEntitiesWithinAABB(TheKing.class, this.boundingBox.expand(48.0, 32.0, 48.0));
    ...
    public void onUpdate() {
        ...
        if (this.worldObj.isRemote) {
            ...
            List var5 = this.worldObj.getEntitiesWithinAABB(TheKing.class, this.boundingBox.expand(32.0, 32.0, 32.0));
            Iterator var2 = var5.iterator();
            Entity var3 = null;
            TheKing var4 = null;
            if (var2.hasNext()) {
