 ...
 *  danger.orespawn.CreeperRepellent
...
extends BlockTorch {
    ...
    private void findSomethingToRepell(World par1World, int par2, int par3, int par4) {
        AxisAlignedBB bb = AxisAlignedBB.getBoundingBox((double)((double)par2 - 20.0), (double)((double)par3 - 10.0), (double)((double)par4 - 20.0), (double)((double)par2 + 20.0), (double)((double)par3 + 10.0), (double)((double)par4 + 20.0));
