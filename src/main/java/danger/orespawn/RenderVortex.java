...
import danger.orespawn.ModelVortex;
...
extends RenderLiving {
    ...
    private static final ResourceLocation texture = new ResourceLocation("orespawn", "Vortextexture.png");

    public RenderVortex(ModelVortex par1ModelBase, float par2, float par3) {
        super((ModelBase)par1ModelBase, par2 * par3);
        this.model = (ModelVortex)this.mainModel;
        this.scale = par3;
    }

    public void renderVortex(Vortex par1EntityVortex, double par2, double par4, double par6, float par8, float par9) {
    ...
    protected void preRenderScale(Vortex par1Entity, float par2) {
