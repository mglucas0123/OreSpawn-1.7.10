 ...
 *  danger.orespawn.RenderHerculesBeetle
...
import danger.orespawn.ModelHerculesBeetle;
...
extends RenderLiving {
    ...
    private static final ResourceLocation texture = new ResourceLocation("orespawn", "Beetletexture.png");

    public RenderHerculesBeetle(ModelHerculesBeetle par1ModelBase, float par2, float par3) {
    ...
    public void renderHerculesBeetle(HerculesBeetle par1EntityHerculesBeetle, double par2, double par4, double par6, float par8, float par9) {
        super.doRender((EntityLiving)par1EntityHerculesBeetle, par2, par4, par6, par8, par9);
    }
