...
extends EntityLiving {
    ...
    public void updateLegs() {
        ...
        for (i = 0; i < 8; ++i) {
            ...
            if ((bid = this.worldObj.getBlock((int)this.renderdata.foot_xpos[i], (int)this.renderdata.foot_ypos[i] - 1, (int)this.renderdata.foot_zpos[i])) != Blocks.grass || this.riddenByEntity == null || !this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing")) continue;
    ...
    public void onUpdate() {
        ...
        if (this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && !this.worldObj.isRemote && this.riddenByEntity != null && this.worldObj.rand.nextInt(15) == 0) {
            ...
            if (e != null) {
                if (this.getDistanceSqToEntity((Entity)e) < (double)((12.0f + e.width / 2.0f) * (12.0f + e.width / 2.0f))) {
                    this.setAttacking(1);
        ...
        if (this.worldObj.rand.nextInt(8) == 0) {
            this.worldObj.spawnParticle("flame", this.posX + (double)dx, this.posY + 2.0, this.posZ + (double)dz, (double)(dx / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0f), (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 10.0f), (double)(dz / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0f));
        }
        if (this.worldObj.rand.nextInt(2) == 0) {
            this.worldObj.spawnParticle("smoke", this.posX + (double)dx, this.posY + 2.0, this.posZ + (double)dz, (double)(dx / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0f), (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 10.0f), (double)(dz / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0f));
        }
        if (this.worldObj.rand.nextInt(10) == 0) {
            this.worldObj.spawnParticle("fireworksSpark", this.posX + (double)dx, this.posY + 2.0, this.posZ + (double)dz, (double)(dx / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0f), (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 5.0f), (double)(dz / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0f));
        }
    }
    ...
    public boolean feetattackEntityAsMob(Entity par1Entity) {
        ...
        if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
            ...
            ret = par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), (float)OreSpawnMain.SpiderRobot_stats.attack / 10.0f);
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(20.0, 12.0, 20.0));
        Iterator var2 = var5.iterator();
        Entity var3 = null;
        EntityLivingBase var4 = null;
        while (var2.hasNext()) {
    ...
    public boolean attackEntityAsMob(Entity par1Entity) {
        ...
        if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
            ...
            double inair = 0.15;
            float f3 = (float)Math.atan2(par1Entity.posZ - this.posZ, par1Entity.posX - this.posX);
            ret = par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), (float)OreSpawnMain.SpiderRobot_stats.attack);
            if (par1Entity.isDead || par1Entity instanceof EntityPlayer) {
                inair *= 2.0;
            }
            if (ret) {
