 ...
 *  danger.orespawn.QueenSpawnerBlock
...
extends BlockReed {
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if (OreSpawnMain.TheQueenEnable != 0) {
            QueenSpawnerBlock.spawnTheQueen((World)par1World, (double)par2, (double)(par3 + 8), (double)par4);
        }
    ...
    public static Entity spawnTheQueen(World par0World, double par2, double par4, double par6) {
        Entity var8 = null;
        var8 = EntityList.createEntityByName((String)"The Queen", (World)par0World);
        if (var8 != null) {
