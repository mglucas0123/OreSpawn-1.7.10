 ...
 *  danger.orespawn.RenderMosquito
...
import danger.orespawn.ModelMosquito;
...
extends RenderLiving {
    ...
    private static final ResourceLocation texture = new ResourceLocation("orespawn", "mosquito.png");

    public RenderMosquito(ModelMosquito par1ModelBase, float par2, float par3) {
    ...
    public void renderMosquito(EntityMosquito par1EntityMosquito, double par2, double par4, double par6, float par8, float par9) {
        super.doRender((EntityLiving)par1EntityMosquito, par2, par4, par6, par8, par9);
    }
    ...
    protected void preRenderScale(EntityMosquito par1Entity, float par2) {
