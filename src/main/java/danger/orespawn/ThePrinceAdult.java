...
extends EntityTameable {
    ...
    public ThePrinceAdult(World par1World) {
        ...
        this.tasks.addTask(4, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityLiving.class, 20.0f));
    ...
    public boolean attackEntityAsMob(Entity par1Entity) {
        ...
        if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
            ...
            par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), iskraken * 100.0f);
    ...
    public void updateAITasks() {
        ...
        if (this.getActivity() == 0 && this.riddenByEntity == null && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && this.isTamed() && OreSpawnMain.FullPowerKingEnable != 0) {
            ++this.growcounter;
            if (this.growcounter > 288000) {
                Entity ent = null;
                TheKing d = null;
                ent = ThePrinceAdult.spawnCreature((World)this.worldObj, (String)"The King", (double)this.posX, (double)this.posY, (double)this.posZ);
                if (ent != null) {
                    d = (TheKing)ent;
                    d.setFree();
                    this.setDead();
    ...
    public void fly_with_rider() {
        ...
        if (this.worldObj.rand.nextInt(5) == 1 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
            ...
            if (e != null) {
                this.setAttacking(1);
                if (this.getDistanceSqToEntity((Entity)e) < (double)((10.0f + e.width / 2.0f) * (10.0f + e.width / 2.0f))) {
                    this.attackEntityAsMob((Entity)e);
                } else if (this.getDistanceSqToEntity((Entity)e) < 625.0 && !this.isInWater() && this.getThePrinceAdultFire() != 0) {
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(32.0, 20.0, 32.0));
    ...
    public void onUpdate() {
        ...
        if (this.getActivity() == 0 && this.isTamed() && this.getOwner() != null && !this.isSitting() && this.getDistanceSqToEntity((Entity)(e = this.getOwner())) > 900.0) {
            this.setActivity(1);
        }
    }
    ...
    private void fly_without_rider() {
        ...
        if (!toofar && this.flyaway == 0 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && this.worldObj.rand.nextInt(6) == 1) {
            ...
            if (e != null) {
                if (this.isTamed() && this.getHealth() / (float)this.mygetMaxHealth() < 0.25f) {
                    ...
                    if (this.getDistanceSqToEntity((Entity)e) < (double)((10.0f + e.width / 2.0f) * (10.0f + e.width / 2.0f))) {
                        ...
                        do_new = true;
                    } else if (this.getDistanceSqToEntity((Entity)e) < 600.0 && !this.isInWater() && this.getThePrinceAdultFire() != 0 && this.worldObj.rand.nextInt(2) == 1) {
                        this.shoot_something(e.posX, e.posY, e.posZ);
                    }
                }
            } else {
            ...
            while (bid != Blocks.air && keep_trying != 0) {
                ...
                if (has_owner) {
                    ...
                    if (this.owner_flying == 0) {
                        zdir = this.worldObj.rand.nextInt(16) + 8;
                        xdir = this.worldObj.rand.nextInt(16) + 8;
                    } else {
                        zdir = this.worldObj.rand.nextInt(12);
                        xdir = this.worldObj.rand.nextInt(12);
                    }
                } else {
                    zdir = this.worldObj.rand.nextInt(15) + 20;
                    xdir = this.worldObj.rand.nextInt(15) + 20;
                }
                ...
                if (this.riddenByEntity != null) {
                    ...
                    if (this.fireballticker == 0 && (pp.moveStrafing < -0.001f || pp.moveStrafing > 0.001f)) {
                        ...
                        if (this.which_attack == 0) {
                            ...
                            bf.setBig();
                            bf.setNotMe();
                            bf.setPosition(cx, this.posY + (yoff -= (double)((float)this.getHead1Ext() * 0.08f)), cz);
                        ...
                        if (this.which_attack == 1) {
                            cx = this.posX - xzoff * Math.sin(Math.toRadians(this.rotationYaw + 10.0f));
                            cz = this.posZ + xzoff * Math.cos(Math.toRadians(this.rotationYaw + 10.0f));
                            IceBall var2 = new IceBall(this.worldObj, cx, this.posY + (yoff -= (double)((float)this.getHead3Ext() * 0.08f)), cz);
                        ...
                        if (this.which_attack == 2) {
                            ...
                            lb.setLocationAndAngles(cx, this.posY + (yoff -= (double)((float)this.getHead2Ext() * 0.08f)), cz, pp.rotationYaw + 90.0f, pp.rotationPitch);
                            lb.motionX *= 3.0;
                            lb.motionY *= 3.0;
                            lb.motionZ *= 3.0;
                    ...
                    this.motionY *= 0.94;
                    this.motionZ *= 0.985;
                    if (!this.worldObj.isRemote && (list = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.expand(6.25, 10.0, 6.25))) != null && !list.isEmpty()) {
    ...
    public boolean interact(EntityPlayer par1EntityPlayer) {
        ...
        if (var2 != null && var2.getItem() == Item.getItemFromBlock((Block)Blocks.diamond_block) && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0) {
            if (!this.worldObj.isRemote) {
        ...
        if (this.isTamed()) {
            ...
            if (var2 == null && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0) {
                if (!this.worldObj.isRemote) {
            ...
            if (var2 != null && var2.getItem() == Items.beef && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0) {
                if (this.worldObj.isRemote) {
            ...
            if (var2 != null && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0 && var2.getItem() instanceof ItemFood) {
                if (!this.worldObj.isRemote) {
            ...
            if (var2 != null && var2.getItem() == Item.getItemFromBlock((Block)Blocks.ice) && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0) {
                if (!this.worldObj.isRemote) {
                    this.playTameEffect(true);
            ...
            if (var2 != null && var2.getItem() == Items.flint_and_steel && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0) {
                if (!this.worldObj.isRemote) {
                    this.playTameEffect(true);
                    this.worldObj.setEntityState((Entity)this, (byte)6);
                    this.setThePrinceAdultFire(1);
            ...
            if (var2 != null && var2.getItem() == Items.diamond && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0 && !this.worldObj.isRemote) {
                Entity ent = null;
                ThePrinceTeen d = null;
                ent = ThePrinceAdult.spawnCreature((World)this.worldObj, (String)"The Young Prince", (double)this.posX, (double)this.posY, (double)this.posZ);
                if (ent != null) {
                    d = (ThePrinceTeen)ent;
                    if (this.isTamed()) {
                        d.setTamed(true);
            ...
            if (this.isTamed() && var2 != null && var2.getItem() == Items.name_tag && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0 && this.func_152114_e((EntityLivingBase)par1EntityPlayer)) {
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound) {
        ...
        par1NBTTagCompound.setInteger("ThePrinceAdultAttacking", this.getAttacking());
        par1NBTTagCompound.setInteger("ThePrinceAdultActivity", this.getActivity());
        par1NBTTagCompound.setInteger("ThePrinceAdultFire", this.getThePrinceAdultFire());
        par1NBTTagCompound.setInteger("ThePrinceAdultGrow", this.growcounter);
    }

    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound) {
        super.readEntityFromNBT(par1NBTTagCompound);
        this.setAttacking(par1NBTTagCompound.getInteger("ThePrinceAdultAttacking"));
        this.setActivity(par1NBTTagCompound.getInteger("ThePrinceAdultActivity"));
        this.setThePrinceAdultFire(par1NBTTagCompound.getInteger("ThePrinceAdultFire"));
        this.growcounter = par1NBTTagCompound.getInteger("ThePrinceAdultGrow");
    }
