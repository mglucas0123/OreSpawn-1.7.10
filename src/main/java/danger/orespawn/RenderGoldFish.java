 ...
 *  danger.orespawn.RenderGoldFish
...
import danger.orespawn.ModelGoldFish;
...
extends RenderLiving {
    ...
    public void doRender(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9) {
        this.renderGoldFish((GoldFish)par1EntityLiving, par2, par4, par6, par8, par9);
    }

    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
        this.renderGoldFish((GoldFish)par1Entity, par2, par4, par6, par8, par9);
    }
    ...
    protected void preRenderCallback(EntityLivingBase par1EntityLiving, float par2) {
        this.preRenderScale((GoldFish)par1EntityLiving, par2);
    }
