...
extends EntityTameable {
    ...
    public boolean interact(EntityPlayer par1EntityPlayer) {
        ...
        if (var2 != null && var2.getItem() == Items.diamond && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 16.0 && this.func_152114_e((EntityLivingBase)par1EntityPlayer) && !this.worldObj.isRemote && this.ok_to_grow != 0) {
            Entity ent = null;
            ThePrinceTeen d = null;
            ent = ThePrince.spawnCreature((World)this.worldObj, (String)"The Young Prince", (double)this.posX, (double)this.posY, (double)this.posZ);
            if (ent != null) {
                d = (ThePrinceTeen)ent;
                if (this.isTamed()) {
                    d.setTamed(true);
