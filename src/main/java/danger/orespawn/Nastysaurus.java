...
extends EntityMob {
    ...
    private void dropItemRand(Item index, int par1) {
        EntityItem var3 = new EntityItem(this.worldObj, this.posX + (double)OreSpawnMain.OreSpawnRand.nextInt(4) - (double)OreSpawnMain.OreSpawnRand.nextInt(4), this.posY + 3.0, this.posZ + (double)OreSpawnMain.OreSpawnRand.nextInt(4) - (double)OreSpawnMain.OreSpawnRand.nextInt(4), new ItemStack(index, par1, 0));
    ...
    protected void updateAITasks() {
        ...
        if (this.worldObj.rand.nextInt(5) == 0) {
            ...
            if (e != null) {
                ...
                if (this.getDistanceSqToEntity((Entity)e) < (double)((4.5f + e.width / 2.0f) * (4.5f + e.width / 2.0f))) {
                    this.setAttacking(1);
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(32.0, 8.0, 32.0));
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (Nastysaurus)this.worldObj.findNearestEntityWithinAABB(Nastysaurus.class, this.boundingBox.expand(16.0, 8.0, 16.0), (Entity)this);
        if (target != null) {
            return false;
        }
        return true;
