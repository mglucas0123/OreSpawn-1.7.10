...
extends EntityMob {
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        ...
        if (e != null && e instanceof EntityPlayer && (p = (EntityPlayer)e).getCurrentEquippedItem() == null) {
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        List var5 = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(6.0, 4.0, 6.0));
    ...
    private int findBuddies() {
        List var5 = this.worldObj.getEntitiesWithinAABB(Irukandji.class, this.boundingBox.expand(16.0, 8.0, 16.0));
        return var5.size();
    }
