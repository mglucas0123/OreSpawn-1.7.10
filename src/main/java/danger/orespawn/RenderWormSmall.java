 ...
 *  danger.orespawn.RenderWormSmall
...
import danger.orespawn.ModelWormSmall;
...
extends RenderLiving {
    ...
    private static final ResourceLocation texture = new ResourceLocation("orespawn", "WormSmalltexture.png");

    public RenderWormSmall(ModelWormSmall par1ModelBase, float par2, float par3) {
        super((ModelBase)par1ModelBase, par2 * par3);
        this.model = (ModelWormSmall)this.mainModel;
        this.scale = par3;
    }

    public void renderWormSmall(WormSmall par1WormSmall, double par2, double par4, double par6, float par8, float par9) {
        super.doRender((EntityLiving)par1WormSmall, par2, par4, par6, par8, par9);
    }
