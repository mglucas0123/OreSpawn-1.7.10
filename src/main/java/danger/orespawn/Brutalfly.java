...
extends EntityMob {
    ...
    protected void updateAITasks() {
        ...
        if (this.stuck_count > 30 || this.worldObj.rand.nextInt(200) == 0 || this.currentFlightTarget.getDistanceSquared((int)this.posX, (int)this.posY, (int)this.posZ) < 9.0f) {
            ...
            while (bid != Blocks.air && keep_trying != 0) {
                ...
                this.currentFlightTarget.set((int)this.posX + (newx *= xdir), (int)this.posY + this.worldObj.rand.nextInt(7) - 1 - down, (int)this.posZ + (newz *= zdir));
        ...
        if (this.worldObj.rand.nextInt(6) == 0) {
            ...
            target = (EntityPlayer)this.worldObj.findNearestEntityWithinAABB(EntityPlayer.class, this.boundingBox.expand(30.0, 20.0, 30.0), (Entity)this);
            if (target != null) {
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (Brutalfly)this.worldObj.findNearestEntityWithinAABB(Brutalfly.class, this.boundingBox.expand(64.0, 32.0, 64.0), (Entity)this);
        if (target != null) {
            return false;
        }
        return true;
    ...
    protected void dropFewItems(boolean par1, int par2) {
        ...
        for (var4 = 0; var4 < 20; ++var4) {
            Brutalfly.spawnCreature((World)this.worldObj, (String)"Butterfly", (double)(this.posX + 0.5), (double)(this.posY + 1.0), (double)(this.posZ + 0.5));
        }
    }
