...
extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        float newangle = 0.0f;
        ThePrinceAdult k = (ThePrinceAdult)entity;
        ...
        if (k.getAttacking() != 0) {
            newangle = MathHelper.cos((float)(f2 * 0.75f * this.wingspeed)) * 3.1415927f * 0.21f;
        } else {
            newangle = MathHelper.cos((float)(f2 * 0.35f * this.wingspeed)) * 3.1415927f * 0.15f;
            if (k.getActivity() == 0) {
                newangle = MathHelper.cos((float)(f2 * 0.35f * this.wingspeed)) * 3.1415927f * 0.15f * f1;
            }
        }
        if (k.isSitting()) {
            newangle = 0.0f;
        ...
        newangle = 0.0f;
        if (k.getAttacking() != 0) {
            newangle = MathHelper.cos((float)(f2 * 0.75f * this.wingspeed)) * 3.1415927f * 0.25f;
        }
        ...
        newangle = 0.0f;
        if (k.getAttacking() != 0) {
            newangle = MathHelper.cos((float)(f2 * 0.6f * this.wingspeed)) * 3.1415927f * 0.45f;
        } else if (!k.isSitting() && k.getActivity() == 0) {
            newangle = MathHelper.cos((float)(f2 * 0.3f * this.wingspeed)) * 3.1415927f * 0.25f * f1;
        }
        ...
        if (k.getAttacking() != 0) {
            ...
            if (k.getActivity() != 0) {
                ...
                Ljawangle = MathHelper.sin((float)(f2 * 0.25f * this.wingspeed)) * 3.1415927f * 0.03f;
                Rjawangle = MathHelper.sin((float)(f2 * 0.35f * this.wingspeed)) * 3.1415927f * 0.03f;
                Cjawangle = MathHelper.sin((float)(f2 * 0.45f * this.wingspeed)) * 3.1415927f * 0.03f;
            }
            Ljawangle += 0.25f;
            Ljawangle += Lheadud;
            Cjawangle += 0.25f;
    ...
    private void moveLeftHead(float Lheadlr, float Lheadud, float Ljawangle) {
        ...
        this.LJaw1.rotationPointZ = this.NeckL4.rotationPointZ + -38.0f * (float)Math.cos(this.NeckL4.rotateAngleX);
        this.LJaw1.rotationPointZ += (float)Math.sin(this.LHead1.rotateAngleX) * 12.0f;
        this.LJaw1.rotationPointX = (float)((double)this.LHead1.rotationPointX - Math.sin(this.LHead1.rotateAngleY) * 7.0);
    ...
    private void moveCenterHead(float Cheadlr, float Cheadud, float Cjawangle) {
        ...
        this.CJaw1.rotationPointZ = this.NeckC4.rotationPointZ + -38.0f * (float)Math.cos(this.NeckC4.rotateAngleX);
        this.CJaw1.rotationPointZ += (float)Math.sin(this.CHead1.rotateAngleX) * 12.0f;
        this.CJaw1.rotationPointX = (float)((double)this.CHead1.rotationPointX - Math.sin(this.CHead1.rotateAngleY) * 7.0);
    ...
    private void moveRightHead(float Rheadlr, float Rheadud, float Rjawangle) {
        ...
        this.RJaw1.rotationPointZ = this.NeckR4.rotationPointZ + -38.0f * (float)Math.cos(this.NeckR4.rotateAngleX);
        this.RJaw1.rotationPointZ += (float)Math.sin(this.RHead1.rotateAngleX) * 12.0f;
        this.RJaw1.rotationPointX = (float)((double)this.RHead1.rotationPointX - Math.sin(this.RHead1.rotateAngleY) * 7.0);
